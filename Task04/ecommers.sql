...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"347429253d505267615c394a3c234e6f",text_dir:"ltr",LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.0",auth_type:"config",user:"root"});
...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=ecommerce&table=orders_products">
    `ecommerce`.`orders_products`
  </a>
</li>
<li class="warp_link">
...
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=ecommerce&table=brands">
    `ecommerce`.`brands`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=ecommerce&table=sub_categories">
    `ecommerce`.`sub_categories`
  </a>
</li>
<li class="warp_link">
...
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=ecommerce&table=categories">
...
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=ecommerce&table=sub_gategories">
    `ecommerce`.`sub_gategories`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=ecommerce&table=gategories">
    `ecommerce`.`gategories`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=ecommerce&table=space">
    `ecommerce`.`space`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
  ...
  <li class="last database">
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.d2VhdGhlcg==" data-vpath="cm9vdA==.d2VhdGhlcg==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=weather"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=weather" title="Structure">weather</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="347429253d505267615c394a3c234e6f">
