                ...
                <div class="col-lg-9">
                    ...
                    <div class="grid-list-product-wrapper">
                        <div class="product-grid product-view pb-20">
                            <div class="row">
                                <?php foreach ($ResultProducts as $Valproducts) { ?>

                                <div class=" col-md-4 mb-30">
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img alt="" src="assets/img/product/<?= $Valproducts["image"] ?>">
                                            </a>
                                        ...
                                        <div class="product-content text-left">
                                            <div class="product-hover-style">
                                                <div class="product-title">
                                                    <h4>
                                                        <a href="product-details.php"><?= $Valproducts["name_en"] ?></a>
                                                    </h4>
                                                </div>
                                                <div class="cart-hover">
                                                    <h4><a href="product-details.php"><?= $Valproducts["name_en"] ?></a>
                                                    </h4>
                                                </div>
                                            </div>
                                            <div class="product-price-wrapper">
                                                <span><?= $Valproducts["price"]  ?> EGY</span>
                                            </div>
                                        </div>
