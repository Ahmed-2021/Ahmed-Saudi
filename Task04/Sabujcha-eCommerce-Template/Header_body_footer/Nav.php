...
use App\Database\Models\categorie;
use App\Database\Models\Sub_Categorie;

$Sub_Categorie = new Sub_Categorie;
$categorie = new categorie;
$ResultCategorie = $categorie->read()->fetch_all(MYSQLI_ASSOC);
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li class="mega-menu-position top-hover"><a href="shop.php">shop</a>
                                        <ul class="mega-menu">
                                            <?php foreach ($ResultCategorie as $value) {
                                                $Sub_Categorie->setCategorie_id($value["id"]);
                                                $SubResult = $Sub_Categorie->getsubcategorie()->fetch_all(MYSQLI_ASSOC);
