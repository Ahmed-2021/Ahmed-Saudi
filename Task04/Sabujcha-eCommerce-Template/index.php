...
use App\Database\Models\orders_product;
use App\Database\Models\Proudct;

$Title = "Home";
include "Header_body_footer/Header.php";
include "Header_body_footer/Nav.php";
$products = new Proudct;
$orderproduct = new orders_product;
$brand = new brand;
$Resultorderproducts = $orderproduct->read()->fetch_all(MYSQLI_ASSOC);
$ResultBrand = $brand->read()->fetch_all(MYSQLI_ASSOC);
$Resultproducts = $products->read()->fetch_all(MYSQLI_ASSOC);
...
<body>
    ...
    <div class="product-area bg-image-1 pt-100 pb-95">
        <div class="container">
            <div class="row">
                ...
                <?php foreach ($ResultBrand as $ImgBrand) { ?>
                <div class="col-md-4">
                    <div class="product-img mb-3">
                        <a href="product-details.php">
                            <img alt="" src="assets/img/logo/<?= $ImgBrand["image"] ?>">
                        </a>
                    </div>
                </div>
                <?php } ?>
        ...
        <div class="container">
            <div class="product-top-bar section-border mb-55">
                <div class="section-title-wrap text-center">
                    <h3 class="section-title">Most Products</h3>
                </div>
            </div>
            <div class="tab-content jump">
                <div class="row">
                    <?php foreach ($Resultproducts as $product) { ?>
                    <?php foreach ($Resultorderproducts as $order) { ?>
                    <?php if ($product["id"] == $order["product_id"]   && $order["quantity"] >= 10) {  ?>
    ...
    <div class="product-area gray-bg pt-90 pb-65">
        <div class="container">
            <div class="product-top-bar section-border mb-55">
                <div class="section-title-wrap text-center">
                    <h3 class="section-title">New Date Products</h3>
                </div>
            </div>
            <div class="tab-content jump">
                <div class="row">
                    <?php foreach ($Resultproducts as $product) { ?>
                    <?php if ($product["LAST_DAY(created_at)"] == "2022-09-30") {  ?>
    ...
    <?php include "Header_body_footer/footer.php" ?>