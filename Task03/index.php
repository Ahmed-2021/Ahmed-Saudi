...
// <![CDATA[
CommonParams.setAll({common_query:"lang=en",opendb_url:"index.php?route=/database/structure&lang=en",lang:"en",server:"1",table:"",db:"",token:"6f45307d212844363f28666c7e60693e",text_dir:"ltr",LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.0",auth_type:"config",user:"root"});
...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=ecommerce&table=addresses&lang=en">
    `ecommerce`.`addresses`
  </a>
</li>
<li class="warp_link">
...
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=ecommerce&table=admins&lang=en">
    `ecommerce`.`admins`
  </a>
</li>
<li class="warp_link">
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="6f45307d212844363f28666c7e60693e">
